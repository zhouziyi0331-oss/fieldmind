...
async def knowledge_analyze(
    ...
    try:
        ...
        # 执行Agent
        agent_result = agent.execute(analysis_input)
...
async def search_query(
    ...
    try:
        ...
        agent = SuperSearchAgent(
            agent_id=f"search_{execution_id}",
            db_session=db
        )
        ...
        agent_result = agent.execute(search_input)
...
async def summary_generate(
    ...
    try:
        ...
        agent = SuperSummaryAgent(
            agent_id=f"summary_{execution_id}",
            db_session=db
        )
        ...
        agent_result = agent.execute(summary_input)
...
async def transcript_process(
    ...
    try:
        ...
        agent = SuperTranscriptAgent(
            agent_id=f"transcript_{execution_id}",
            db_session=db
        )
        ...
        agent_result = agent.execute(transcript_input)
