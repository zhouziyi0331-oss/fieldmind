...
from app.tools.vectorization import UnifiedVectorizationEngine, VectorEngine, StorageBackend, DocumentChunk
from app.tools.knowledge.graph import create_knowledge_graph
from app.models.project import ProjectDocument

logger = logging.getLogger(__name__)

# 全局单例：确保整个应用只有一个统一向量化引擎实例
...
def get_vectorization_service():
    ...
    if _global_vectorizer is None:
        _global_vectorizer = UnifiedVectorizationEngine(
...
class DocumentProcessingPipeline:
    ...
    def __init__(self):
        ...
        self.kg_service = create_knowledge_graph()  # 新增：知识图谱服务
