...
from app.models.document_chunk import DocumentChunk, VectorizationService
...
class SourceTracebackService:
    ...
    def __init__(self, db: Session):
        self.db = db
        self.vectorizer = UnifiedVectorizationEngine(engine=VectorEngine.BGE_LARGE, storage=StorageBackend.DUAL)
