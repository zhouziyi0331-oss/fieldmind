            ...
            try:
                ...
                self.db.execute(text("""
                    INSERT INTO fact_statements (
                        source_file, document_id, project_id,
                        speaker, start_sec, end_sec,
                        original_text, clean_text,
                        topic_tag, entity_names, keywords,
                        sentence_type, chunk_index, word_count,
                ...
                """), {
                    ...
                    'speaker': fact_data['speaker'],
                    'start_sec': fact_data['start_sec'],
                    'end_sec': fact_data['end_sec'],
                    'original_text': chunk_text,
                    'clean_text': fact_data['clean_text'],
                    'topic_tag': fact_data['topic_tag'],
                    'entity_names': fact_data['entity_names'],
                    'keywords': fact_data['keywords'],
                    'sentence_type': fact_data['sentence_type'],
                    'chunk_index': i,
                    'word_count': len(fact_data['clean_text']),
