...
RAGFLOW_API_URL = settings.ai.ragflow_api_url
RAGFLOW_API_KEY = settings.ai.ragflow_api_key
...
class RAGFlowService:
    ...
    def __init__(self, api_url: str = RAGFLOW_API_URL, api_key: str = RAGFLOW_API_KEY, use_workflow_engine: bool = True):
