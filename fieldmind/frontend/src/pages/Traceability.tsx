...
import { traceabilityAPI } from '@/services/fieldmind-api'
...
import { GitBranch, Plus, Search, Edit, Trash2, Filter, RefreshCw } from 'lucide-react'
...
export default function Traceability() {
  ...
  const handleCreate = async () => {
    try {
      await traceabilityAPI.createTrace(formData)
      toast({
        title: '创建成功',
        description: '数据已创建'
      })
    ...
    <div className="p-8 space-y-8">
      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">管理和监控可追溯性数据</p>
        </div>
...
<Card className="stat-card"><div className="stat-value">{stats.tracked || 0}</div><div className="stat-label">已跟踪</div></Card>
<Card className="stat-card"><div className="stat-value">{stats.changes || 0}</div><div className="stat-label">变更</div></Card>
<Card className="stat-card"><div className="stat-value">{stats.versions || 0}</div><div className="stat-label">版本</div></Card>
      </div>
        ...
        <div className="p-6">
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 mb-4">还没有任何可追溯性数据</p>
      ...
      <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            <DialogTitle>创建可追溯性</DialogTitle>
          </DialogHeader>
