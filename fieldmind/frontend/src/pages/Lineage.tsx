...
import { GitMerge, Plus, Search, Edit, Trash2, Filter, RefreshCw } from 'lucide-react'
...
export default function Lineage() {
  ...
  const handleCreate = async () => {
    try {
      await lineageAPI.createLineage(formData)
      toast({
        title: '创建成功',
        description: '数据已创建'
      })
  ...
  const handleUpdate = async () => {
    try {
      await lineageAPI.updateLineage(selectedItem.id, formData)
      toast({
        title: '更新成功',
        description: '数据已更新'
      })
    ...
    <div className="p-8 space-y-8">
      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">管理和监控数据血缘数据</p>
        </div>
...
<Card className="stat-card"><div className="stat-value">{stats.upstream || 0}</div><div className="stat-label">上游</div></Card>
<Card className="stat-card"><div className="stat-value">{stats.downstream || 0}</div><div className="stat-label">下游</div></Card>
<Card className="stat-card"><div className="stat-value">{stats.depth || 0}</div><div className="stat-label">深度</div></Card>
      </div>
        ...
        <div className="p-6">
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 mb-4">还没有任何数据血缘数据</p>
      ...
      <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            <DialogTitle>创建数据血缘</DialogTitle>
          </DialogHeader>
          <div className="space-y-4 py-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">源ID</label>
                  <Input
                    type="text"
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            <DialogTitle>编辑数据血缘</DialogTitle>
          </DialogHeader>
          <div className="space-y-4 py-4">
