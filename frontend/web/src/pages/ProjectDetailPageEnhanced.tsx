...
const ProjectDetailPage: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'quality' | 'traceability' | 'collaboration'>('overview');
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {activeTab === 'traceability' && (
          <TraceabilityPanel
            projectId={Number(projectId)}
            onAudioSeek={(documentId, timestamp) => {
              console.log(`跳转到文档 ${documentId} 的时间戳 ${timestamp}`);
              // TODO: 集成音频播放器
            }}
          />
        )}
        ...
        {activeTab === 'collaboration' && (
          <CollaborationPanel
            ...
            currentUserRole="OWNER" // TODO: 从用户上下文获取
          />
        )}
      </div>
    </div>
