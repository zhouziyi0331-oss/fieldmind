...
import { crawlerAPI } from '@/services/fieldmind-api'
...
import { Globe, Plus, Search, Edit, Trash2, Filter, RefreshCw } from 'lucide-react'
...
export default function Crawler() {
  ...
  const handleCreate = async () => {
    try {
      await crawlerAPI.createTask(formData)
      toast({
        title: '创建成功',
        description: '数据已创建'
      })
    ...
    <div className="p-8 space-y-8">
      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">管理和监控爬虫任务数据</p>
        </div>
...
<Card className="stat-card"><div className="stat-value">{stats.completed || 0}</div><div className="stat-label">已完成</div></Card>
        ...
        <div className="p-6">
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 mb-4">还没有任何爬虫任务数据</p>
      ...
      <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
        <DialogContent className="max-w-2xl">
          ...
          <div className="space-y-4 py-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">起始URL</label>
                  <Input
                    type="text"
                    value={formData.url || ''}
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">爬取深度</label>
                  <Input
                    type="number"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">最大页数</label>
                  <Input
                    type="number"
