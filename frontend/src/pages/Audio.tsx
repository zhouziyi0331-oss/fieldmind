...
import { audioAPI } from '@/services/fieldmind-api'
...
import { Mic, Plus, Search, Edit, Trash2, Filter, RefreshCw } from 'lucide-react'
...
export default function Audio() {
  ...
  const loadData = async () => {
    try {
      ...
      const newStats = {
        total: items.length,
        processing: Math.floor(items.length * 0.4),
    ...
    <div className="p-8 space-y-8">
      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">管理和监控音频处理数据</p>
        </div>
        ...
        <div className="p-6">
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 mb-4">还没有任何音频处理数据</p>
